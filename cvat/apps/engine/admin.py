...
from .models import Task, Segment, Job, Label, AttributeSpec, Project, CloudStorage, CameraName
...
class CameraNameAdmin(admin.ModelAdmin):
    model = CameraName
...
admin.site.register(CameraName, CameraNameAdmin)
